...
2. 開いたスクリプトエディタ上のコード.gsに本リポジトリの <a href="https://github.com/kotakahashi-4u/NotebookLMSlide2GoogleSlide/blob/main/code.gs" target="_blank">code.gs</a>(Windows: **Ctrl+Click** / Mac: **Cmd+Click**) の内容をコピーする。
...
5. 作成したSidebar.htmlに本リポジトリの <a href="https://github.com/kotakahashi-4u/NotebookLMSlide2GoogleSlide/blob/main/Sidebar.html" target="_blank">Sidebar.html</a>(Windows: **Ctrl+Click** / Mac: **Cmd+Click**) の内容をコピーする。
